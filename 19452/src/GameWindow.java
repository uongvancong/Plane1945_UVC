...
//        g.fillRect(PlaneManager.getInstance().getPlaneMoveByKey().positionX,PlaneManager.getInstance().getPlaneMoveByKey().positionY,PlaneManager.getInstance().getPlaneMoveByKey().getHp(), 5 );
        super.paint(g);
